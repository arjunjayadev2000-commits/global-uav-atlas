...
| Pass | Strategies | Candidates seen | New candidates | Failed strategies |
| ---: | ---: | ---: | ---: | ---: |
| 0 | 1 | 1238 | 1238 | 0 |
| 1 | 13 | 159 | 156 | 12 |
...
See `output/unresolved_records.csv` and `docs/UNRESOLVED.md` for the detail.
